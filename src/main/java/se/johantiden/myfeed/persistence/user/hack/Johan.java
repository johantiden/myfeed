...
public class Johan extends User {
    ...
    private static Predicate<Document> redditCategories() {
        ArrayList<Predicate<Document>> predicates = Lists.<Predicate<Document>>newArrayList(
                ...
                categoryContains("overwatch"),
                categoryContains("savedyouaclick"),
                categoryContains("bettereveryloop"),
                categoryContains("jokes"),
                categoryContains("murica"),
                categoryContains("latestagecapitalism"),
